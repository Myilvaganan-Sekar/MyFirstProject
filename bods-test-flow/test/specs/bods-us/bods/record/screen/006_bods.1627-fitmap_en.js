...
describe("BODS :: Screen", async () => {
  it("recorder :: 1627-fitmap_en", async () => {
    await Homepage.open();
   ...
   */
  // ================================
  it("image comparison v1.1.4 :: 1627-fitmap_en", async function() {
    ...
    await utils.checkFireWall("006_bods.1627-fitmap_en");
    ...
    // await utils.addCaptureOpts("006_bods.1627-fitmap_en", "fullPageScrollTimeout", 3000, "web");
    // await utils.addCaptureOpts("006_bods.1627-fitmap_en", "ignoreTransparentPixel", true, "web");
    // await utils.addCaptureOpts("006_bods.1627-fitmap_en", "ignoreAntialiasing", true, "web");
    // await utils.addCaptureOpts("006_bods.1627-fitmap_en", "scaleImagesToSameSize", false, "web");
    // await utils.addCaptureOpts("006_bods.1627-fitmap_en", "largeImageThreshold", 100, "web");
    // await utils.addCaptureOpts("006_bods.1627-fitmap_en", "disableCSSAnimation", true, "web");
    // await utils.addCaptureOpts("006_bods.1627-fitmap_en", "ignoreColors", true, "web");
    // await utils.addCaptureOpts("006_bods.1627-fitmap_en", "ignoreAlpha", false, "web");

    // CORE (active) :: IMG COMPARISON STEP
    await utils.imgCompare("bods", "006_bods.1627-fitmap_en");
