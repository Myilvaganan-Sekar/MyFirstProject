...
describe("BODS :: Screen", async () => {
  it("recorder :: 1627-Existingaccountpolo_en", async () => {
    await Homepage.open();
   ...
   */
  // ================================
  it("image comparison v1.1.4 :: 1627-Existingaccountpolo_en", async function() {
    ...
    // await utils.addCaptureOpts("003_bods.1627-Existingaccountpolo_en", "fullPageScrollTimeout", 9000, "web");
    // await utils.addCaptureOpts("003_bods.1627-Existingaccountpolo_en", "ignoreTransparentPixel", true, "web");
    // await utils.addCaptureOpts("003_bods.1627-Existingaccountpolo_en", "ignoreAntialiasing", true, "web");
    // await utils.addCaptureOpts("003_bods.1627-Existingaccountpolo_en", "scaleImagesToSameSize", false, "web");
    // await utils.addCaptureOpts("003_bods.1627-Existingaccountpolo_en", "largeImageThreshold", 100, "web");
    // await utils.addCaptureOpts("003_bods.1627-Existingaccountpolo_en", "disableCSSAnimation", true, "web");
    // await utils.addCaptureOpts("003_bods.1627-Existingaccountpolo_en", "ignoreColors", true, "web");
    // await utils.addCaptureOpts("003_bods.1627-Existingaccountpolo_en", "ignoreAlpha", false, "web");

    // CORE (active) :: IMG COMPARISON STEP
    await utils.imgCompare("bods", "003_bods.1627-Existingaccountpolo_en");
