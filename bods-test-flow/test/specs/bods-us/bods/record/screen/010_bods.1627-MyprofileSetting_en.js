...
describe("BODS :: Screen", async () => {
  it("recorder :: 1627-MyprofileSetting_en", async () => {
    await Homepage.open();
    ...
    await myprofilepage.scrolltocupsize();
  });
   ...
   */
  // ================================
  it("image comparison v1.1.4 :: 1627-MyprofileSetting_en", async function() {
    ...
    await utils.checkFireWall("010_bods.1627-MyprofileSetting_en");
    ...
    // await utils.addCaptureOpts("010_bods.1627-MyprofileSetting_en", "fullPageScrollTimeout", 3000, "web");
    // await utils.addCaptureOpts("010_bods.1627-MyprofileSetting_en", "ignoreTransparentPixel", true, "web");
    // await utils.addCaptureOpts("010_bods.1627-MyprofileSetting_en", "ignoreAntialiasing", true, "web");
    // await utils.addCaptureOpts("010_bods.1627-MyprofileSetting_en", "scaleImagesToSameSize", false, "web");
    // await utils.addCaptureOpts("010_bods.1627-MyprofileSetting_en", "largeImageThreshold", 100, "web");
    // await utils.addCaptureOpts("010_bods.1627-MyprofileSetting_en", "disableCSSAnimation", true, "web");
    // await utils.addCaptureOpts("010_bods.1627-MyprofileSetting_en", "ignoreColors", true, "web");
    // await utils.addCaptureOpts("010_bods.1627-MyprofileSetting_en", "ignoreAlpha", false, "web");

    // CORE (active) :: IMG COMPARISON STEP
    await utils.imgCompare("bods", "010_bods.1627-MyprofileSetting_en");
