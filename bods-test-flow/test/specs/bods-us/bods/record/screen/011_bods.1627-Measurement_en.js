...
const home_page = require('../../pageobjects/home_page');

describe("BODS :: Screen", async () => {
  it("recorder :: 1627-Measurement_en", async () => {
    await Homepage.open();
    ...
    await myprofilepage.scrolltomeasurment();
    await home_page.waitForLoadingToDisappear();
  });
   ...
   */
  // ================================
  it("image comparison v1.1.4 :: 1627-Measurement_en", async function() {
    ...
    await utils.checkFireWall("011_bods.1627-Measurement_en");
    ...
    // await utils.addCaptureOpts("011_bods.1627-Measurement_en", "fullPageScrollTimeout", 3000, "web");
    // await utils.addCaptureOpts("011_bods.1627-Measurement_en", "ignoreTransparentPixel", true, "web");
    // await utils.addCaptureOpts("011_bods.1627-Measurement_en", "ignoreAntialiasing", true, "web");
    // await utils.addCaptureOpts("011_bods.1627-Measurement_en", "scaleImagesToSameSize", false, "web");
    // await utils.addCaptureOpts("011_bods.1627-Measurement_en", "largeImageThreshold", 100, "web");
    // await utils.addCaptureOpts("011_bods.1627-Measurement_en", "disableCSSAnimation", true, "web");
    // await utils.addCaptureOpts("011_bods.1627-Measurement_en", "ignoreColors", true, "web");
    // await utils.addCaptureOpts("011_bods.1627-Measurement_en", "ignoreAlpha", false, "web");

    // CORE (active) :: IMG COMPARISON STEP
    await utils.imgCompare("bods", "011_bods.1627-Measurement_en");
