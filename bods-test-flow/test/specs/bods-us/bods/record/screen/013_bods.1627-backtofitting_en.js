...
describe("BODS :: Screen", async () => {
  it("recorder :: 1627-backtofitting_en", async () => {
    await Homepage.open();
   ...
   */
  // ================================
  it("image comparison v1.1.4 :: 1627-backtofitting_en", async function() {
    ...
    await utils.checkFireWall("013_bods.1627-backtofitting_en");
    ...
    // await utils.addCaptureOpts("013_bods.1627-backtofitting_en", "fullPageScrollTimeout", 3000, "web");
    // await utils.addCaptureOpts("013_bods.1627-backtofitting_en", "ignoreTransparentPixel", true, "web");
    // await utils.addCaptureOpts("013_bods.1627-backtofitting_en", "ignoreAntialiasing", true, "web");
    // await utils.addCaptureOpts("013_bods.1627-backtofitting_en", "scaleImagesToSameSize", false, "web");
    // await utils.addCaptureOpts("013_bods.1627-backtofitting_en", "largeImageThreshold", 100, "web");
    // await utils.addCaptureOpts("013_bods.1627-backtofitting_en", "disableCSSAnimation", true, "web");
    // await utils.addCaptureOpts("013_bods.1627-backtofitting_en", "ignoreColors", true, "web");
    // await utils.addCaptureOpts("013_bods.1627-backtofitting_en", "ignoreAlpha", false, "web");

    // CORE (active) :: IMG COMPARISON STEP
    await utils.imgCompare("bods", "013_bods.1627-backtofitting_en");
