const hookCustom = require("./utils/lib/hook");
...
exports.config = {
  ...
  // hostname: "localhost",
  user: process.env.BROWSERSTACK_USERNAME || "tranhuydat_u3pfhv",
  key: process.env.BROWSERSTACK_ACCESS_KEY || "ySExJJ6R4FnEaWVuis8y",
  ...
  services: [
    [
      "browserstack",
      {
        app: "./test/specs/bods/automation-samples/data/demo_takephoto.apk",
        buildIdentifier: "${BUILD_NUMBER}",
        browserstackLocal: true,
      },
    ],
  ], //["native-app-compare", img_comparison_config]
  ...
  onWorkerStart: async function (cid, caps, specs, args, execArgv) {
    // GENERATE BASELINE FOLDER PATH
    await hookCustom.generateMobileCompareConfig(specs, args);
