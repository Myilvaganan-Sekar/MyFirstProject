...
async function determineIgnoreRectangles(base64Image, options) {
  ...
  if (deviceInfo.isSmallIphone && options.blockOutIphoneHomeBar) {
    rectangles = rectangles.concat(deviceInfo.rectangles.iOSHomeBar);
  }

  if (deviceInfo.isMediumIphone && options.blockOutIphoneHomeBar) {
    rectangles = rectangles.concat(deviceInfo.rectangles.iOSHomeBar);
  }

  if (deviceInfo.isLargeIphone && options.blockOutIphoneHomeBar) {
    rectangles = rectangles.concat(deviceInfo.rectangles.iOSHomeBar);
  }

  if (deviceInfo.isExtraLargeIphone && options.blockOutIphoneHomeBar) {
    rectangles = rectangles.concat(deviceInfo.rectangles.iOSHomeBar);
  }
